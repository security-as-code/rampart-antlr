...
import org.rampart.antlr.v4.runtime.IntStream;
...
import org.rampart.antlr.v4.runtime.atn.CodePointTransitions;
import org.rampart.antlr.v4.runtime.atn.LexerAction;
import org.rampart.antlr.v4.runtime.atn.LexerChannelAction;
import org.rampart.antlr.v4.runtime.atn.LexerCustomAction;
import org.rampart.antlr.v4.runtime.atn.LexerModeAction;
import org.rampart.antlr.v4.runtime.atn.LexerMoreAction;
import org.rampart.antlr.v4.runtime.atn.LexerPopModeAction;
import org.rampart.antlr.v4.runtime.atn.LexerPushModeAction;
import org.rampart.antlr.v4.runtime.atn.LexerSkipAction;
import org.rampart.antlr.v4.runtime.atn.LexerTypeAction;
...
import org.rampart.antlr.v4.runtime.atn.TokensStartState;
...
import org.rampart.antlr.util.ObjectUtils;
...
public class LexerATNFactory extends ParserATNFactory {
	...
	private static class CharSetParseState {
		...
		public boolean equals(Object other) {
			...
			return ObjectUtils.equals(this.mode, that.mode) &&
				ObjectUtils.equals(this.inRange, that.inRange) &&
				ObjectUtils.equals(this.prevCodePoint, that.prevCodePoint) &&
				ObjectUtils.equals(this.prevProperty, that.prevProperty);
		}

		@Override
		public int hashCode() {
			return ObjectUtils.hash(mode, inRange, prevCodePoint, prevProperty);
		}
	}
	...
	private Integer getTokenConstantValue(String tokenName, Token token) {
		...
		if (tokenType != org.rampart.antlr.v4.runtime.Token.INVALID_TYPE) {
			return tokenType;
		}
	...
	private Integer getChannelConstantValue(String channelName, Token token) {
		...
		if (channelValue >= org.rampart.antlr.v4.runtime.Token.MIN_USER_CHANNEL_VALUE) {
			return channelValue;
		}

...
public abstract class EscapeSequenceParsing {
	public static class Result {
		...
		public boolean equals(Object other) {
			...
			return ObjectUtils.equals(this.type, that.type) &&
				ObjectUtils.equals(this.codePoint, that.codePoint) &&
				ObjectUtils.equals(this.propertyIntervalSet, that.propertyIntervalSet) &&
				ObjectUtils.equals(this.parseLength, that.parseLength);
		}

		@Override
		public int hashCode() {
			return ObjectUtils.hash(type, codePoint, propertyIntervalSet, parseLength);
		}
	}
